namespace AspNet.Identity.IntegerKeys.Example
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser, int>
    {
            ...
            IOwinContext context)
        {
            ...
            manager.RegisterTwoFactorProvider("Phone Code", new PhoneNumberTokenProviderWithIntKey<ApplicationUser>
            {
                MessageFormat = "Your security code is {0}"
            });
            manager.RegisterTwoFactorProvider("Email Code", new EmailTokenProviderWithIntKey<ApplicationUser>
            {
